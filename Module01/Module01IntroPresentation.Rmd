...
Course: https://www.ntnu.edu/studies/courses/TMA4315#tab=omEmnet

Wiki: https://wiki.math.ntnu.no/tma4315/2025h/start

GitHub: https://github.com/oharar/TMA4315

![](WikiTMA4315_2025.png){height=40%}
...
**PLAN:** You recapitulate what you have learned in TMA4267 Linear statistical models (or an equivalent course!), and in the plenary lectures we focus on a three-step model, likelihood theory and formal inference connected to the likelihood. Instead of sums-of-squares of error (MSE, RSS) we will use deviance. 
