...
\title{\texorpdfstring{Module 2: MULTIPLE LINEAR REGRESSION Week
1}{Module 2: MULTIPLE LINEAR REGRESSION Week 1}}
\subtitle{\texorpdfstring{TMA4315 Generalized linear models
H2018}{TMA4315 Generalized linear models H2018}}
\author{\texorpdfstring{Mette Langaas, Department of Mathematical
Sciences, NTNU -- with contributions from Øyvind Bakke and Ingeborg
Hem}{Mette Langaas, Department of Mathematical Sciences, NTNU -- with contributions from Øyvind Bakke and Ingeborg Hem}}
...
\protect\phantomsection\label{learning-material}
\begin{itemize}
\tightlist
\item
...
\begin{frame}
\begin{block}{Topics}
\protect\phantomsection\label{topics}
\begin{block}{\hyperlink{firstweek}{First week}}
\protect\phantomsection\label{first-week}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{second-week}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{aim-of-multiple-linear-regression}
\begin{enumerate}
\item
...
\protect\phantomsection\label{munich-rent-index}
...
\protect\phantomsection\label{munich-rent-index-variables}
\begin{itemize}
\tightlist
\item
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{Module02MLRPresentationWeek1_files/Module02MLRPresentationWeek1_files/figure-beamer/unnamed-chunk-1-1.pdf}}
\end{frame}
...
\protect\phantomsection\label{hands-on-munich-rent-index-response-and-covariates}
...
\begin{frame}{Model}
\protect\phantomsection\label{model}
\begin{block}{The traditional way}
\protect\phantomsection\label{the-traditional-way}
...
\protect\phantomsection\label{the-glm-way}
...
\protect\phantomsection\label{parameter-estimation}
...
\protect\phantomsection\label{likelihood-theory}
\begin{block}{Likelihood \(L(\beta)\)}
\protect\phantomsection\label{likelihood-lbeta}
...
linear regression model. (we will go through this and the equivalent
questions in the interactive session)
\end{block}
\end{block}
\end{frame}
...
\protect\phantomsection\label{loglikelihood-lbeta}
...
\protect\phantomsection\label{rules-for-derivatives-of-vector}
...
\protect\phantomsection\label{rules-for-derivatives-of-vector-ii}
\textbf{Rule 1:}
...
\protect\phantomsection\label{score-function-sbeta}
...
\({\boldsymbol \beta}\):}
\protect\phantomsection\label{least-squares-and-maximum-likelihood-ml-estimator-for-boldsymbol-beta}
\[
...
\protect\phantomsection\label{looking-ahead-hessian-and-fisher-information}
...
\protect\phantomsection\label{hands-on-munich-rent-index-parameter-estimates}
...
\({\boldsymbol \sigma}^2\)}
\protect\phantomsection\label{restricted-maximum-likelihood-estimator-for-boldsymbol-sigma2}
\[
...
\protect\phantomsection\label{properties-for-the-normal-linear-model}
...
(optional)}
\protect\phantomsection\label{are-hatboldsymbolbeta-and-sse-are-independent-optional}
...
\protect\phantomsection\label{checking-model-assumptions}
\end{frame}

\begin{frame}{Checking model assumptions}
\protect\phantomsection\label{checking-model-assumptions-1}
...
\protect\phantomsection\label{residuals}
...
\protect\phantomsection\label{standardized-residuals}
...
\protect\phantomsection\label{studentized-residuals}
...
violated?}
\protect\phantomsection\label{plotting-residuals---and-what-to-do-when-assumptions-are-violated}
...
\protect\phantomsection\label{diagnostic-plots-in-r}
...
\protect\phantomsection\label{residuals-vs-fitted-values}
...
\pandocbounded{\includegraphics[keepaspectratio]{Module02MLRPresentationWeek1_files/Module02MLRPresentationWeek1_files/figure-beamer/unnamed-chunk-7-1.pdf}}
\end{frame}

\begin{frame}[fragile]
\begin{block}{Normal Q-Q}
\protect\phantomsection\label{normal-q-q}
This plot shows if the residuals are Gaussian (normally) distributed. If
they follow a straight line it is an indication that they are, and else
...
\pandocbounded{\includegraphics[keepaspectratio]{Module02MLRPresentationWeek1_files/Module02MLRPresentationWeek1_files/figure-beamer/unnamed-chunk-8-1.pdf}}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{Scale-location}
\protect\phantomsection\label{scale-location}
...
\pandocbounded{\includegraphics[keepaspectratio]{Module02MLRPresentationWeek1_files/Module02MLRPresentationWeek1_files/figure-beamer/unnamed-chunk-9-1.pdf}}
\end{frame}

\begin{frame}
\begin{block}{Residual vs Leverage}
\protect\phantomsection\label{residual-vs-leverage}
...
\pandocbounded{\includegraphics[keepaspectratio]{Module02MLRPresentationWeek1_files/Module02MLRPresentationWeek1_files/figure-beamer/unnamed-chunk-10-1.pdf}}
...
\protect\phantomsection\label{categorical-covariates---dummy-and-effect-coding}
...
\protect\phantomsection\label{ozone}
...
\protect\phantomsection\label{the-hierarchical-principle}
...
\protect\phantomsection\label{the-hierarchical-principle-why}
...
\protect\phantomsection\label{interactions-between-qualitative-discrete-and-quantitative-continuous-covariates}
...
\protect\phantomsection\label{ozone-make-temperature-categorical}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{model-with-interaction}
\begin{Shaded}
\begin{Highlighting}[]
...
\pandocbounded{\includegraphics[keepaspectratio]{Module02MLRPresentationWeek1_files/Module02MLRPresentationWeek1_files/figure-beamer/unnamed-chunk-16-1.pdf}}
\end{frame}
