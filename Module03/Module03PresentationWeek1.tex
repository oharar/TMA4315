...
\phantomsection\label{aim-of-binary-regression}
\begin{block}{Two aims}
\phantomsection\label{two-aims}
\begin{enumerate}
\tightlist
\item
...
\phantomsection\label{example-dose-response-of-beetles}
A total of 481 flour beetles (\emph{Tribolium confusum}) were exposed to
8 different concentration of CS\(_2\) (data on log10-dose).
...
\phantomsection\label{how-to-model-a-binary-response}
...
\phantomsection\label{binary-regression}
\begin{enumerate}
\tightlist
\item
...
\phantomsection\label{linear-predictor}
...
\phantomsection\label{response-function-for-binary-regression}
...
\phantomsection\label{the-logit-model-aka-logistic-regression}
...
\phantomsection\label{link-and-reponse-function}
...
\phantomsection\label{interpreting-the-logit-model}
...
\phantomsection\label{to-sum-up}
...
estimates}
\phantomsection\label{infant-respiratory-disease-interpretating-parameter-estimates}
...
\phantomsection\label{more-response-function-plots-for-the-logit-model}
...
\phantomsection\label{grouped-vs.-individual-data}
...
\phantomsection\label{likelihood-and-derivations-thereof}
...
\phantomsection\label{likelihood-lboldsymbolbeta}
...
\phantomsection\label{loglikelihood-lboldsymbolbeta}
\begin{align}
...
\phantomsection\label{score-function-sboldsymbolbeta}
