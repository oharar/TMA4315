...
$\lambda = \exp(-3.63222 + 0.98039 -0.04781  + \log(1)) = \exp(2.817813) = 16.7402$
...
$$
E(N_{a,s_1}) =\lambda(a,s_1) = \exp(\beta_0 + \sum_{j=1}^6\beta_j I(a=j) + \beta_7 I(s_1=2)  + \log(1))
$$

where $I(a=j)$ is an indicator that $a=j$, i.e. $I(a=j)=1 iff a=j$, and $\beta_2, ...\beta_6$ are the coefficients for ages 1 to 5, and $I(s_1=k)$ is an indicator that $a=j$, i.e. $I(a=j)=1 iff a=j$, and $\beta_2, ...\beta_6$
