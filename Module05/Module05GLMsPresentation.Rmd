...
### Requirements of the link function
...
In then exercise session we can study the proof, but it is also given in the notes and as a video.
...
Go to the notes and watch a video.
