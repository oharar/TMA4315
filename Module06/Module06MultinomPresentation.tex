...
\phantomsection\label{categorical-random-component}
...
\phantomsection\label{categorical-regression}
...
\phantomsection\label{the-multinomial-distribution}
...
\phantomsection\label{ungrouped-data}
...
\phantomsection\label{grouped-data}
...
\phantomsection\label{regression-with-nominal-responses}
nominal=unordered
...
\phantomsection\label{multivariate-glm}
...
\phantomsection\label{multivariate-glm-set-up}
\begin{enumerate}
\tightlist
\item
...
\phantomsection\label{likelihood}
(grouped data)
...
\phantomsection\label{loglikelihood}
...
\phantomsection\label{alligators-example}
...
\phantomsection\label{regression-with-ordinal-responses}
...
\phantomsection\label{response-function}
...
\phantomsection\label{plotting-the-cumulative-probabilites}
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{Module06MultinomPresentation_files/figure-beamer/unnamed-chunk-9-1.pdf}}
\end{frame}

\begin{frame}
\begin{block}{Mental health data example}
\phantomsection\label{mental-health-data-example}
...
\phantomsection\label{why-not-use-mlr-instead-of-ordinal-regression}
...
\phantomsection\label{likelihood-inference}
...
\begin{block}{Loglikelihood}
\phantomsection\label{loglikelihood-1}
...
\phantomsection\label{design-matrix-and-coefficient-vector}
...
\phantomsection\label{nominal-logit-model}
...
\phantomsection\label{ordinal-cumulative-model}
...
\phantomsection\label{score-function}
...
\phantomsection\label{summing-up}
\end{frame}
