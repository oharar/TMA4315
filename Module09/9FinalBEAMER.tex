...
\item
  ...
  contraceptive use.
\item
  {[}M4{]} Female horseshoe crabs with satellites, smoking and lung cancer, time
...
\item
  ...
  analysis} (not until next spring!)
\item
